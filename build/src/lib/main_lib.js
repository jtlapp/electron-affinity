...
function exposeMainApi(mainApi, restorer) {
    ...
    (0, shared_lib_1.exposeApi)(_mainApiMap, mainApi, function (ipcName, method) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, [returnValue, restorer_lib_1.Restorer.makeRestorationInfo(returnValue)]];
                    case 2:
                        err_1 = _a.sent();
                        if (err_1 instanceof RelayedError) {
                            return [2 /*return*/, restorer_lib_1.Restorer.makeRethrownReturnValue(err_1.errorToRelay)];
                        }
...
function _attemptBindWindowApi(window, apiClassName, resolve) {
    ...
    if (!windowApiMap || !windowApiMap[apiClassName]) {
        ...
        window.webContents.send(shared_lib_1.API_REQUEST_IPC, apiClassName);
        return false;
    }
    ...
    var _loop_1 = function (methodName) {
        ...
        boundApi[typedMethodName] = (function () {
            ...
            window.webContents.send((0, shared_lib_1.toIpcName)(apiClassName, methodName), args);
...
function _installIpcListeners() {
    if (!_listeningForIPC) {
        electron_1.ipcMain.on(shared_lib_1.API_REQUEST_IPC, function (event, apiClassName) {
            var registration = {
                className: apiClassName,
                methodNames: _mainApiMap[apiClassName]
            };
            event.sender.send(shared_lib_1.API_RESPONSE_IPC, registration);
        });
        electron_1.ipcMain.on(shared_lib_1.API_RESPONSE_IPC, function (event, api) {
